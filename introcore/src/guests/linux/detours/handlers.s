...
.LFB1:
	...
	.cfi_offset 3, -32
	mov	rbx, rax	#,
# handlers.c:528:     return  (hypercall_info.Detours[id].EnableOptions == -1ULL)
	inc	rax	# tmp95
...
# handlers.c:529:         || ((hypercall_info.Detours[id].EnableOptions & hypercall_info.ProtectionOptions) != 0);
	cmp	rax, -1	# _8,
	je	.L2	#,
# handlers.c:537:         return 0;
	xor	esi, esi	# <retval>
# handlers.c:536:     if (!is_detour_enabled(id)) {
	test	QWORD PTR hypercall_info[rip], rax	# hypercall_info.ProtectionOptions, _8
	je	.L1	#,
.L2:
# handlers.c:542:     asm volatile("vmcall" : "+S" (_out_param), "+a"(_out_value) : "D"(24), "b"(id): );
...
# 542 "handlers.c" 1
	vmcall
# 0 "" 2
# handlers.c:545:     volatile struct inactive_task_frame _reserved = { 0 };
#NO_APP
...
# handlers.c:555:     void *path = (void *)((unsigned long)hypercall_info.OsSpecificFields.PercpuMemPtr + (current_cpu * PAGE_SIZE));
	mov	esi, DWORD PTR hypercall_info[rip+11908]	# hypercall_info.OsSpecificFields.CurrentCpuOffset, hypercall_info.OsSpecificFields.CurrentCpuOffset
#APP
# 555 "handlers.c" 1
	mov esi, gs:[rsi]	# ret, hypercall_info.OsSpecificFields.CurrentCpuOffset
# 0 "" 2
# handlers.c:557:     return hypercall_info.OsSpecificFields.DPathFnPtr(path_struct, path, PAGE_SIZE);
#NO_APP
	mov	edx, 4096	#,
# handlers.c:555:     void *path = (void *)((unsigned long)hypercall_info.OsSpecificFields.PercpuMemPtr + (current_cpu * PAGE_SIZE));
	sal	esi, 12	#,
	add	rsi, QWORD PTR hypercall_info[rip+11912]	# path, hypercall_info.OsSpecificFields.PercpuMemPtr
# handlers.c:557:     return hypercall_info.OsSpecificFields.DPathFnPtr(path_struct, path, PAGE_SIZE);
	call	[QWORD PTR hypercall_info[rip+11920]]	# hypercall_info.OsSpecificFields.DPathFnPtr
# handlers.c:558: }
	add	rsp, 8	#,
	.cfi_def_cfa_offset 72
	pop	rdx	#
...
# handlers.c:581:     regs.Rax = __read_reg("rax");
#APP
# 581 "handlers.c" 1
	mov rax, rax	# val
...
# handlers.c:582:     regs.Rcx = __read_reg("rcx");
#APP
# 582 "handlers.c" 1
	mov rax, rcx	# val
...
# handlers.c:583:     regs.Rdx = __read_reg("rdx");
#APP
# 583 "handlers.c" 1
	mov rax, rdx	# val
...
# handlers.c:584:     regs.Rbx = __read_reg("rbx");
#APP
# 584 "handlers.c" 1
	mov rax, rbx	# val
...
# handlers.c:585:     regs.Rsp = __read_reg("rsp");
#APP
# 585 "handlers.c" 1
	mov rax, rsp	# val
...
# handlers.c:586:     regs.Rbp = __read_reg("rbp");
#APP
# 586 "handlers.c" 1
	mov rax, rbp	# val
...
# handlers.c:587:     regs.Rsi = __read_reg("rsi");
#APP
# 587 "handlers.c" 1
	mov rax, rsi	# val
...
# handlers.c:588:     regs.Rdi = __read_reg("rdi");
#APP
# 588 "handlers.c" 1
	mov rax, rdi	# val
...
# handlers.c:589:     regs.R8 = __read_reg("r8");
#APP
# 589 "handlers.c" 1
	mov rax, r8	# val
...
# handlers.c:590:     regs.R9 = __read_reg("r9");
#APP
# 590 "handlers.c" 1
	mov rax, r9	# val
...
# handlers.c:591:     regs.R10 = __read_reg("r10");
#APP
# 591 "handlers.c" 1
	mov rax, r10	# val
...
# handlers.c:592:     regs.R11 = __read_reg("r11");
#APP
# 592 "handlers.c" 1
	mov rax, r11	# val
...
# handlers.c:593:     regs.R12 = __read_reg("r12");
#APP
# 593 "handlers.c" 1
	mov rax, r12	# val
...
# handlers.c:594:     regs.R13 = __read_reg("r13");
#APP
# 594 "handlers.c" 1
	mov rax, r13	# val
...
# handlers.c:595:     regs.R14 = __read_reg("r14");
#APP
# 595 "handlers.c" 1
	mov rax, r14	# val
...
# handlers.c:596:     regs.R15 = __read_reg("r15");
#APP
# 596 "handlers.c" 1
	mov rax, r15	# val
	
# 0 "" 2
# handlers.c:598:     void *dst = (void *)((unsigned long)hypercall_info.OsSpecificFields.PercpuMemPtr + (current_cpu * PAGE_SIZE));
#NO_APP
	mov	edi, DWORD PTR hypercall_info[rip+11908]	# hypercall_info.OsSpecificFields.CurrentCpuOffset, hypercall_info.OsSpecificFields.CurrentCpuOffset
# handlers.c:596:     regs.R15 = __read_reg("r15");
...
#NO_APP
	sal	edi, 12	#,
	add	rdi, QWORD PTR hypercall_info[rip+11912]	# dst, hypercall_info.OsSpecificFields.PercpuMemPtr
# handlers.c:599:     _memcpy(dst, &regs, sizeof(regs));
	mov	rsi, rsp	# tmp131,
	mov	edx, 224	#,
	call	_memcpy	#
# handlers.c:600: }
...
.LFB5:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 8, -24
# handlers.c:607:     void *current = current_task;
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
# handlers.c:606: {
	push	rdi	#
	.cfi_def_cfa_offset 32
	.cfi_offset 5, -32
...
# 0 "" 2
# handlers.c:609:     if (!hypercall_info.OsSpecificFields.Info.CredAltered) {
#NO_APP
	cmp	DWORD PTR hypercall_info[rip+11824], 0	# hypercall_info.OsSpecificFields.Info.CredAltered,
	jne	.L21	#,
# handlers.c:610:         uint32_t *in_execve = (uint32_t *)((unsigned long)(current) + hypercall_info.OsSpecificFields.Task.InExecve);
	mov	eax, DWORD PTR hypercall_info[rip+11868]	# hypercall_info.OsSpecificFields.Task.InExecve, hypercall_info.OsSpecificFields.Task.InExecve
# handlers.c:612:         if ((*in_execve & BIT(hypercall_info.OsSpecificFields.Task.InExecveBit))) {
	mov	edx, DWORD PTR [r8+rax]	# *in_execve_18, *in_execve_18
	mov	eax, DWORD PTR hypercall_info[rip+11872]	# hypercall_info.OsSpecificFields.Task.InExecveBit, hypercall_info.OsSpecificFields.Task.InExecveBit
	bt	rdx, rax	# *in_execve_18, hypercall_info.OsSpecificFields.Task.InExecveBit
	jc	.L20	#,
.L21:
	mov	r9, rdi	# creds, creds
# handlers.c:617:     vmcall_2(det_commit_creds, current, creds);
	xor	edi, edi	#
	call	vmcall	#
.L20:
# handlers.c:618: }
...
.LFB6:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:625:     vmcall_1(det_module_param_sysfs_setup, module);
	mov	edi, 2	#,
	call	vmcall	#
# handlers.c:626: }
	pop	rax	#
...
.LFB7:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:633:     vmcall_1(det_module_param_sysfs_remove, module);
	mov	edi, 3	#,
	call	vmcall	#
# handlers.c:634: }
	pop	rax	#
...
.LFB8:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 8, -24
# handlers.c:641:     vmcall_2(det_wake_up_new_task, current_task, task);
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
# handlers.c:640: {
	push	rdi	#
	.cfi_def_cfa_offset 32
...
.LFB9:
	.cfi_startproc
# handlers.c:649:     unsigned long file = *(unsigned long *)(binprm + hypercall_info.OsSpecificFields.Binprm.FileOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11876]	# hypercall_info.OsSpecificFields.Binprm.FileOffset, hypercall_info.OsSpecificFields.Binprm.FileOffset
# handlers.c:648: {
	push	r10	#
	.cfi_def_cfa_offset 16
	.cfi_offset 10, -16
...
# handlers.c:652:     if (!file) {
	test	rdi, rdi	# file
	je	.L31	#,
# handlers.c:656:     path_struct = file + hypercall_info.OsSpecificFields.File.PathOffset;
	mov	edx, DWORD PTR hypercall_info[rip+11884]	# hypercall_info.OsSpecificFields.File.PathOffset, hypercall_info.OsSpecificFields.File.PathOffset
	add	rdi, rdx	# file, hypercall_info.OsSpecificFields.File.PathOffset
.L31:
# handlers.c:659:     return vmcall_3(det_flush_old_exec, current_task, binprm, d_path((void *)path_struct));
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 659 "handlers.c" 1
	mov r8, gs:[r8]	# ret, hypercall_info.OsSpecificFields.CurrentTaskOffset
...
.LFB10:
	.cfi_startproc
# handlers.c:667:     unsigned long file = *(unsigned long *)(binprm + hypercall_info.OsSpecificFields.Binprm.FileOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11876]	# hypercall_info.OsSpecificFields.Binprm.FileOffset, hypercall_info.OsSpecificFields.Binprm.FileOffset
# handlers.c:666: {
	push	r10	#
	.cfi_def_cfa_offset 16
...
# handlers.c:667:     unsigned long file = *(unsigned long *)(binprm + hypercall_info.OsSpecificFields.Binprm.FileOffset);
	mov	rdi, QWORD PTR [rax+rdi]	# file, *_4
# handlers.c:670:     if (!file) {
	test	rdi, rdi	# file
	je	.L37	#,
# handlers.c:674:     path_struct = file + hypercall_info.OsSpecificFields.File.PathOffset;
	mov	edx, DWORD PTR hypercall_info[rip+11884]	# hypercall_info.OsSpecificFields.File.PathOffset, hypercall_info.OsSpecificFields.File.PathOffset
	add	rdi, rdx	# file, hypercall_info.OsSpecificFields.File.PathOffset
.L37:
# handlers.c:677:     return vmcall_3(det_begin_new_exec, current_task, binprm, d_path((void *)path_struct));
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 677 "handlers.c" 1
	mov r8, gs:[r8]	# ret, hypercall_info.OsSpecificFields.CurrentTaskOffset
...
.LFB11:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 8, -24
# handlers.c:685:     vmcall_2(det_do_exit, current_task, code);
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
# handlers.c:684: {
	push	rdi	#
	.cfi_def_cfa_offset 32
...
.LFB12:
	.cfi_startproc
# handlers.c:702:     return 0;
	xor	eax, eax	# <retval>
# handlers.c:694:         || request == PTRACE_POKETEXT
	cmp	rsi, 19	# request,
	ja	.L49	#,
# handlers.c:692: {
	push	r9	#
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 1, -48
# handlers.c:693:     if (request == PTRACE_POKEDATA
	mov	edx, 565296	# tmp99,
	bt	rdx, rsi	# tmp99, request
	jnc	.L44	#,
	mov	r9, rsi	# request, request
	mov	r8, rdi	# child, child
# handlers.c:699:         return vmcall_2(det_arch_ptrace, child, request);
	mov	edi, 8	#,
	call	vmcall	#
.L44:
# handlers.c:703: }
...
# handlers.c:710: {
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 8, -24
# handlers.c:715:     return vmcall_2(det_process_vm_rw_core, current_task, pid);
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
# handlers.c:710: {
	push	rdi	#
	.cfi_def_cfa_offset 32
...
.LFB14:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:723:     long mm_flags = *(long *)((long)(mm) + hypercall_info.OsSpecificFields.Mm.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11856]	# hypercall_info.OsSpecificFields.Mm.FlagsOffset, hypercall_info.OsSpecificFields.Mm.FlagsOffset
# handlers.c:725:     if (!(mm_flags & BIT(hypercall_info.OsSpecificFields.Mm.ProtectionBit))) {
	mov	rdx, QWORD PTR [rdi+rax]	# *_5, *_5
	mov	eax, DWORD PTR hypercall_info[rip+11864]	# hypercall_info.OsSpecificFields.Mm.ProtectionBit, hypercall_info.OsSpecificFields.Mm.ProtectionBit
	bt	rdx, rax	# *_5, hypercall_info.OsSpecificFields.Mm.ProtectionBit
	jnc	.L61	#,
# handlers.c:729:     long file = *(long *)((long)(vma) + hypercall_info.OsSpecificFields.Vma.FileOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11836]	# hypercall_info.OsSpecificFields.Vma.FileOffset, hypercall_info.OsSpecificFields.Vma.FileOffset
# handlers.c:730:     if (file) {
	cmp	QWORD PTR [rax+rsi], 0	# *_14,
	jne	.L61	#,
# handlers.c:734:     long vm_flags = *(long *)((long)(vma) + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:735:     if (!(vm_flags & VM_EXEC)) {
	test	BYTE PTR [rsi+rax], 4	# *_18,
	je	.L61	#,
	mov	r8, rsi	# vma, vma
	mov	r9, rdi	# mm, mm
# handlers.c:739:     vmcall_2(det___vma_link_rb, vma, mm);
	mov	edi, 11	#,
	call	vmcall	#
.L61:
# handlers.c:740: }
...
.LFB15:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:748:     long file = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FileOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11836]	# hypercall_info.OsSpecificFields.Vma.FileOffset, hypercall_info.OsSpecificFields.Vma.FileOffset
# handlers.c:749:     if (file) {
	cmp	QWORD PTR [rax+rdi], 0	# *_4,
	jne	.L70	#,
# handlers.c:753:     long mm = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.MmOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11828]	# hypercall_info.OsSpecificFields.Vma.MmOffset, hypercall_info.OsSpecificFields.Vma.MmOffset
	mov	r9, QWORD PTR [rax+rdi]	# mm, *_8
# handlers.c:754:     long mm_flags = *(long *)(mm + hypercall_info.OsSpecificFields.Mm.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11856]	# hypercall_info.OsSpecificFields.Mm.FlagsOffset, hypercall_info.OsSpecificFields.Mm.FlagsOffset
# handlers.c:756:     if (!(mm_flags & BIT(hypercall_info.OsSpecificFields.Mm.ProtectionBit))) {
	mov	rdx, QWORD PTR [rax+r9]	# *_12, *_12
	mov	eax, DWORD PTR hypercall_info[rip+11864]	# hypercall_info.OsSpecificFields.Mm.ProtectionBit, hypercall_info.OsSpecificFields.Mm.ProtectionBit
	bt	rdx, rax	# *_12, hypercall_info.OsSpecificFields.Mm.ProtectionBit
	jnc	.L70	#,
# handlers.c:760:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:762:     if (((vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit)) && !(vm_flags & VM_EXEC))
	mov	esi, DWORD PTR hypercall_info[rip+11852]	# hypercall_info.OsSpecificFields.Vma.ProtectionBit, hypercall_info.OsSpecificFields.Vma.ProtectionBit
# handlers.c:760:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
...
# handlers.c:762:     if (((vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit)) && !(vm_flags & VM_EXEC))
	...
	jmp	.L70	#
.L72:
# handlers.c:763:         || (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit)) && (vm_flags & VM_EXEC))) {
	test	rax, rax	# _42
	je	.L70	#,
.L73:
	mov	r8, rdi	# vma, vma
# handlers.c:766:         vmcall_2(det_change_protection, vma, mm);
	mov	edi, 12	#,
	call	vmcall	#
.L70:
# handlers.c:768: }
...
.LFB16:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 1, -32
# handlers.c:779:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	edx, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:776: {
	push	rax	#
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
...
# handlers.c:777:     *skip_call = 1;
	mov	QWORD PTR [rax], 1	# *skip_call_21(D),
# handlers.c:780:     if (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit))) {
	mov	rsi, QWORD PTR [rdx+rdi]	# *_4, *_4
	mov	edx, DWORD PTR hypercall_info[rip+11852]	# hypercall_info.OsSpecificFields.Vma.ProtectionBit, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	bt	rsi, rdx	# *_4, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	jnc	.L84	#,
# handlers.c:784:     *saved_vma = vma;
	mov	rdx, QWORD PTR 48[rsp]	# saved_vma, saved_vma
	mov	QWORD PTR [rdx], rdi	# *saved_vma_25(D), vma
# handlers.c:785:     *next = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.VmNextOffset);
	mov	edx, DWORD PTR hypercall_info[rip+11840]	# hypercall_info.OsSpecificFields.Vma.VmNextOffset, hypercall_info.OsSpecificFields.Vma.VmNextOffset
	mov	rsi, QWORD PTR [rdx+rdi]	# _13, *_12
	mov	rdx, QWORD PTR 56[rsp]	# next, next
	mov	QWORD PTR [rdx], rsi	# *next_27(D), _13
# handlers.c:786:     *prev = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.VmPrevOffset);
	mov	edx, DWORD PTR hypercall_info[rip+11844]	# hypercall_info.OsSpecificFields.Vma.VmPrevOffset, hypercall_info.OsSpecificFields.Vma.VmPrevOffset
	mov	rsi, QWORD PTR [rdx+rdi]	# _18, *_17
	mov	rdx, QWORD PTR 64[rsp]	# prev, prev
	mov	QWORD PTR [rdx], rsi	# *prev_29(D), _18
# handlers.c:787:     *skip_call = 0;
...
.LFB17:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:799:     long mm = *(long *)(saved_vma + hypercall_info.OsSpecificFields.Vma.MmOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11828]	# hypercall_info.OsSpecificFields.Vma.MmOffset, hypercall_info.OsSpecificFields.Vma.MmOffset
# handlers.c:797: {
	mov	rcx, QWORD PTR 80[rsp]	# saved_vma, saved_vma
# handlers.c:799:     long mm = *(long *)(saved_vma + hypercall_info.OsSpecificFields.Vma.MmOffset);
	mov	rbx, QWORD PTR [rax+rcx]	# mm, *_4
# handlers.c:801:     vmcall_4(det_vma_adjust, svma, mm, next, prev);
	...
	mov	edi, 13	#,
	call	vmcall	#
# handlers.c:802:     vmcall_4(det___vma_adjust, svma, mm, next, prev);
	mov	r10, QWORD PTR 88[rsp]	# __p3, next
	mov	r11, QWORD PTR 96[rsp]	# __p4, prev
	mov	edi, 14	#,
	call	vmcall	#
...
.LFB18:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:810:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:811:     if (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit))) {
	mov	rdx, QWORD PTR [rax+rdi]	# *_4, *_4
	mov	eax, DWORD PTR hypercall_info[rip+11852]	# hypercall_info.OsSpecificFields.Vma.ProtectionBit, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	bt	rdx, rax	# *_4, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	jnc	.L92	#,
	mov	rcx, rdi	# vma, vma
# handlers.c:815:     vmcall_2(det_vma_rb_erase, vma, *(long *)(vma + hypercall_info.OsSpecificFields.Vma.MmOffset));
	mov	r8, rdi	# __p1, vma
	mov	eax, DWORD PTR hypercall_info[rip+11828]	# hypercall_info.OsSpecificFields.Vma.MmOffset, hypercall_info.OsSpecificFields.Vma.MmOffset
	mov	r9, QWORD PTR [rax+rdi]	# __p2, *_13
	mov	edi, 15	#,
	call	vmcall	#
# handlers.c:816:     vmcall_2(det___vma_rb_erase, vma, *(long *)(vma + hypercall_info.OsSpecificFields.Vma.MmOffset));
	mov	eax, DWORD PTR hypercall_info[rip+11828]	# hypercall_info.OsSpecificFields.Vma.MmOffset, hypercall_info.OsSpecificFields.Vma.MmOffset
...
.LFB19:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:824:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:825:     if (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit))) {
	mov	rdx, QWORD PTR [rax+rdi]	# *_4, *_4
	mov	eax, DWORD PTR hypercall_info[rip+11852]	# hypercall_info.OsSpecificFields.Vma.ProtectionBit, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	bt	rdx, rax	# *_4, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	jnc	.L98	#,
	mov	r10, rsi	# address, address
# handlers.c:829:     vmcall_3(det_expand_downwards, vma, *(long *)(vma + hypercall_info.OsSpecificFields.Vma.MmOffset), address);
	mov	r8, rdi	# __p1, vma
	mov	eax, DWORD PTR hypercall_info[rip+11828]	# hypercall_info.OsSpecificFields.Vma.MmOffset, hypercall_info.OsSpecificFields.Vma.MmOffset
	mov	r9, QWORD PTR [rax+rdi]	# __p2, *_13
	mov	edi, 17	#,
...
.LFB20:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 1, -64
# handlers.c:838:         && sig != SIGILL
	cmp	edi, 11	# sig,
	ja	.L105	#,
# handlers.c:837:     if (sig != SIGQUIT
	mov	eax, 2520	# tmp100,
...
# handlers.c:847:     int new_sig = vmcall_3(det_complete_signal, task, sig, type);
	movsx	r9, edi	# __p2, sig
	mov	r10d, edx	# __p3, type
	mov	edi, 18	#,
	call	vmcall	#
	mov	edx, eax	# <retval>, _20
# handlers.c:848:     return new_sig ? new_sig : sig;
	test	eax, eax	# _20
	je	.L105	#,
.L104:
# handlers.c:849: }
...
.LFB21:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 8, -32
# handlers.c:856:     vmcall_3(det_text_poke, addr, opcode, len);
...
# handlers.c:856:     vmcall_3(det_text_poke, addr, opcode, len);
	...
	mov	edi, 19	#,
	call	vmcall	#
# handlers.c:857:     vmcall_3(det___text_poke, addr, opcode, len);
	mov	edi, 20	#,
	call	vmcall	#
# handlers.c:858: }
	pop	rax	#
...
.LFB22:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:865:     vmcall_3(det_ftrace_write, ip, val, size);
...
.LFB23:
	...
	.cfi_def_cfa_offset 16
	.cfi_offset 5, -16
# handlers.c:873:     vmcall(det_panic);
	mov	edi, 22	#,
# handlers.c:872: {
	push	rax	#
	.cfi_def_cfa_offset 24
...
.LFB24:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:881:     vmcall_2(det_arch_jump_label_transform, entry, type);
...
.LFB25:
	.cfi_startproc
# handlers.c:890:     if ((gup_flags & 1) == 0) {
...
# handlers.c:889: {
	...
	.cfi_def_cfa_offset 88
	.cfi_offset 0, -88
# handlers.c:894:     vmcall_5(det___access_remote_vm, mm, addr, buf, len, gup_flags);
	mov	edi, 24	#,
	call	vmcall	#
# handlers.c:895: }
	pop	rax	#
...
.LFB26:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:902:     unsigned long vma = vma_vm_rb - hypercall_info.OsSpecificFields.Vma.Rb;
	mov	eax, DWORD PTR hypercall_info[rip+11848]	# hypercall_info.OsSpecificFields.Vma.Rb, hypercall_info.OsSpecificFields.Vma.Rb
	sub	rdi, rax	# vma_vm_rb, hypercall_info.OsSpecificFields.Vma.Rb
# handlers.c:904:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:906:     if (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit))) {
...
# handlers.c:910:     vmcall_2(det_do_munmap_rb_erase, vma, mm);
# handlers.c:903:     unsigned long mm = mm_mm_rb - hypercall_info.OsSpecificFields.Mm.Rb;
	mov	eax, DWORD PTR hypercall_info[rip+11860]	# _3, hypercall_info.OsSpecificFields.Mm.Rb
	sub	r9, rax	# __p2, _3
# handlers.c:910:     vmcall_2(det_do_munmap_rb_erase, vma, mm);
	mov	edi, 26	#,
	call	vmcall	#
...
.LFB27:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:918:     unsigned long vma = vma_vm_rb - hypercall_info.OsSpecificFields.Vma.Rb;
	mov	eax, DWORD PTR hypercall_info[rip+11848]	# hypercall_info.OsSpecificFields.Vma.Rb, hypercall_info.OsSpecificFields.Vma.Rb
	sub	rdi, rax	# vma_vm_rb, hypercall_info.OsSpecificFields.Vma.Rb
# handlers.c:920:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:922:     if (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit))) {
	mov	rdx, QWORD PTR [rax+rdi]	# *_8, *_8
	mov	eax, DWORD PTR hypercall_info[rip+11852]	# hypercall_info.OsSpecificFields.Vma.ProtectionBit, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	bt	rdx, rax	# *_8, hypercall_info.OsSpecificFields.Vma.ProtectionBit
	jnc	.L132	#,
	mov	r8, rdi	# vma, vma_vm_rb
	mov	r9, rsi	# mm_mm_rb, mm_mm_rb
# handlers.c:926:     vmcall_2(det_vma_adjust_rb_erase, vma, mm);
# handlers.c:919:     unsigned long mm = mm_mm_rb - hypercall_info.OsSpecificFields.Mm.Rb;
	mov	eax, DWORD PTR hypercall_info[rip+11860]	# _3, hypercall_info.OsSpecificFields.Mm.Rb
	sub	r9, rax	# __p2, _3
# handlers.c:926:     vmcall_2(det_vma_adjust_rb_erase, vma, mm);
	mov	edi, 27	#,
...
.LFB28:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:934:     long file = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FileOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11836]	# hypercall_info.OsSpecificFields.Vma.FileOffset, hypercall_info.OsSpecificFields.Vma.FileOffset
# handlers.c:935:     if (file) {
	cmp	QWORD PTR [rax+rdi], 0	# *_4,
	jne	.L138	#,
# handlers.c:939:     long mm = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.MmOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11828]	# hypercall_info.OsSpecificFields.Vma.MmOffset, hypercall_info.OsSpecificFields.Vma.MmOffset
	mov	r9, QWORD PTR [rax+rdi]	# mm, *_8
# handlers.c:940:     long mm_flags = *(long *)(mm + hypercall_info.OsSpecificFields.Mm.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11856]	# hypercall_info.OsSpecificFields.Mm.FlagsOffset, hypercall_info.OsSpecificFields.Mm.FlagsOffset
# handlers.c:942:     if (!(mm_flags & BIT(hypercall_info.OsSpecificFields.Mm.ProtectionBit))) {
	mov	rdx, QWORD PTR [rax+r9]	# *_12, *_12
	mov	eax, DWORD PTR hypercall_info[rip+11864]	# hypercall_info.OsSpecificFields.Mm.ProtectionBit, hypercall_info.OsSpecificFields.Mm.ProtectionBit
	bt	rdx, rax	# *_12, hypercall_info.OsSpecificFields.Mm.ProtectionBit
	jnc	.L138	#,
# handlers.c:946:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	eax, DWORD PTR hypercall_info[rip+11832]	# hypercall_info.OsSpecificFields.Vma.FlagsOffset, hypercall_info.OsSpecificFields.Vma.FlagsOffset
# handlers.c:948:     if (((vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit)) && !(vm_flags & VM_EXEC))
	mov	esi, DWORD PTR hypercall_info[rip+11852]	# hypercall_info.OsSpecificFields.Vma.ProtectionBit, hypercall_info.OsSpecificFields.Vma.ProtectionBit
# handlers.c:946:     long vm_flags = *(long *)(vma + hypercall_info.OsSpecificFields.Vma.FlagsOffset);
	mov	rdx, QWORD PTR [rax+rdi]	# vm_flags, *_20
...
# handlers.c:948:     if (((vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit)) && !(vm_flags & VM_EXEC))
	...
	jmp	.L138	#
.L140:
# handlers.c:949:         || (!(vm_flags & BIT(hypercall_info.OsSpecificFields.Vma.ProtectionBit)) && (vm_flags & VM_EXEC))) {
	test	rax, rax	# _41
	je	.L138	#,
.L141:
	mov	r8, rdi	# vma, vma
# handlers.c:952:         vmcall_2(det_mprotect_fixup_vma_wants_writenotify, vma, mm);
	mov	edi, 25	#,
	call	vmcall	#
.L138:
# handlers.c:954: }
...
.LFB30:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:968:     long save_rax = __read_reg("rax");
#APP
# 968 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:969:     vmcall_3(det_do_rmdir, current_task, save_pathname,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 969 "handlers.c" 1
...
.LFB32:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:986:     long x = __read_reg("rax");
#APP
# 986 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:987: 	vmcall_5(det_sys_sysfs,current_task,save_option,save_arg1,save_arg2,x);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 987 "handlers.c" 1
...
.LFB33:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:994:     long save_rax = __read_reg("rax");
#APP
# 994 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:996:     vmcall_5(det_sys_read,current_task,save_fd, save_buf, save_count,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 996 "handlers.c" 1
...
.LFB35:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:1013:     long save_rax = __read_reg("rax");
#APP
# 1013 "handlers.c" 1
	mov r9, rax	# val
	
# 0 "" 2
# handlers.c:1015:     vmcall_2(det_sys_getppid,current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1015 "handlers.c" 1
...
.LFB37:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1029:     long save_rax = __read_reg("rax");
#APP
# 1029 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1031:     vmcall_3(det_sys_getsid,current_task,save_pid,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1031 "handlers.c" 1
...
.LFB38:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 0, -24
# handlers.c:1038:     *skip_call=0;
	mov	rax, QWORD PTR 24[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1039:     *save_pid=pid;
...
.LFB39:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:1046:     long save_rax = __read_reg("rax");
#APP
# 1046 "handlers.c" 1
	mov r9, rax	# val
	
# 0 "" 2
# handlers.c:1048:     vmcall_2(det_sys_getuid,current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1048 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1064:     vmcall_2(det_sys_geteuid,current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1064 "handlers.c" 1
...
# handlers.c:1077: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1078:     long save_rax = __read_reg("rax");
#APP
# 1078 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1080:     vmcall_4(det_sys_shutdown,current_task,save_a,save_b,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1080 "handlers.c" 1
...
.LFB45:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1096:     long save_rax = __read_reg("rax");
#APP
# 1096 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1098:     vmcall_3(det_do_sysinfo,current_task,save_a,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1098 "handlers.c" 1
...
.LFB46:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 0, -24
# handlers.c:1105:     *skip_call=0;
	mov	rax, QWORD PTR 24[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1106:     *save_a=a;
...
.LFB47:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1113:     long save_rax = __read_reg("rax");
#APP
# 1113 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1115:     vmcall_4(det_sys_capget,current_task,save_header,save_dataptr,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1115 "handlers.c" 1
...
.LFB48:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1122:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1123:     *save_header=header;
	mov	rax, QWORD PTR 40[rsp]	# save_header, save_header
	mov	QWORD PTR [rax], rdi	# *save_header_4(D), header
# handlers.c:1124:     *save_dataptr=dataptr;
...
.LFB49:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1131:     long save_rax = __read_reg("rax");
#APP
# 1131 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1133:     vmcall_4(det_sys_capset,current_task,save_header,save_data,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1133 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1151:     vmcall_4(det_sys_statfs,current_task,save_path,save_buf,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1151 "handlers.c" 1
...
.LFB53:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1167:     long save_rax = __read_reg("rax");
#APP
# 1167 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1169:     vmcall_4(det_sys_fstatfs,current_task,save_fd,save_buf,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1169 "handlers.c" 1
...
.LFB54:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1176:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1177:     *save_fd=fd;
	mov	rax, QWORD PTR 40[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:1178:     *save_buf=buf;
	mov	rax, QWORD PTR 48[rsp]	# save_buf, save_buf
	mov	QWORD PTR [rax], rsi	# *save_buf_7(D), buf
# handlers.c:1179: }
	pop	rax	#
...
.LFB55:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:1185:     long save_rax = __read_reg("rax");
#APP
# 1185 "handlers.c" 1
	mov r9, rax	# val
	
# 0 "" 2
# handlers.c:1187:     vmcall_2(det_sys_setsid,current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1187 "handlers.c" 1
...
# handlers.c:1200: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1201:     long save_rax = __read_reg("rax");
#APP
# 1201 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1203:     vmcall_5(det_sys_seccomp,current_task,save_op,save_flags,save_uargs,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1203 "handlers.c" 1
...
.LFB59:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1220:     long save_rax = __read_reg("rax");
#APP
# 1220 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1222:     vmcall_5(det_sys_tgkill,current_task,save_tgid,save_pid,save_sig,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1222 "handlers.c" 1
...
.LFB61:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1239:     long save_rax = __read_reg("rax");
#APP
# 1239 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1241:     vmcall_4(det_sys_tkill,current_task,save_pid,save_sig,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1241 "handlers.c" 1
...
# handlers.c:1256: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1257:     long save_rax = __read_reg("rax");
#APP
# 1257 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1259:     vmcall_4(det_sys_ustat,current_task,save_dev,save_ubuf,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1259 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1277:     vmcall_5(det_sys_poll,current_task,save_ufds,save_nfds,save_timeout,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1277 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1296:     vmcall_5(det_sys_sigprocmask,current_task,save_how,save_set,save_oset,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1296 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1315:     vmcall_4(det_sys_getrlimit,current_task,save_resource,save_rlim,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1315 "handlers.c" 1
...
# handlers.c:1330: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1331:     long save_rax = __read_reg("rax");
#APP
# 1331 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1333:     vmcall_3(det_sys_getrlimit,current_task,save_mask,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1333 "handlers.c" 1
...
# handlers.c:1348: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1349:     long save_rax = __read_reg("rax");
#APP
# 1349 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1351:     vmcall_5(det_sys_ioctl,current_task,save_fd,save_cmd,save_arg,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1351 "handlers.c" 1
...
.LFB74:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:1358:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1359:     *save_fd=fd;
	mov	rax, QWORD PTR 48[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:1360:     *save_cmd=cmd;
	mov	rax, QWORD PTR 56[rsp]	# save_cmd, save_cmd
	mov	DWORD PTR [rax], esi	# *save_cmd_7(D), cmd
# handlers.c:1361:     *save_arg=arg;
...
# 0 "" 2
# handlers.c:1370:     vmcall_3(det_sys_brk,current_task,save_brk,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1370 "handlers.c" 1
...
.LFB77:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1385:     long save_rax = __read_reg("rax");
#APP
# 1385 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1387:     vmcall_4(det_sys_gettimeofday,current_task,save_tv,save_tz,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1387 "handlers.c" 1
...
# handlers.c:1402: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1403:     long save_rax = __read_reg("rax");
#APP
# 1403 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1405:     vmcall_5(det_sys_setresuid,current_task,save_ruid,save_euid,save_suid,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1405 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1423:     vmcall_3(det_sys_chdir,current_task,save_filename,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1423 "handlers.c" 1
...
# handlers.c:1430:     *skip_call=0;
	mov	rax, QWORD PTR 24[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1431:     *save_filename=filename;
...
.LFB83:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1438:     long save_rax = __read_reg("rax");
#APP
# 1438 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1440:     vmcall_3(det_sys_alarm,current_task,save_seconds,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1440 "handlers.c" 1
...
.LFB84:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 0, -24
# handlers.c:1447:     *skip_call=0;
	mov	rax, QWORD PTR 24[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1448:     *save_seconds=seconds;
...
.LFB85:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1455:     long save_rax = __read_reg("rax");
#APP
# 1455 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1457:     vmcall_6(det_sys_ptrace,current_task,save_request,save_pid,save_addr,save_data,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1457 "handlers.c" 1
...
.LFB87:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1475:     long save_rax = __read_reg("rax");
#APP
# 1475 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1477:     vmcall_3(det_sys_time,current_task,save_tloc,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1477 "handlers.c" 1
...
.LFB88:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 0, -24
# handlers.c:1484:     *skip_call=0;
	mov	rax, QWORD PTR 24[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1485:     *save_tloc=tloc;
...
.LFB89:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1492:     long save_rax = __read_reg("rax");
#APP
# 1492 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1494:     vmcall_3(det_sys_chroot,current_task,save_filename,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1494 "handlers.c" 1
...
# handlers.c:1508: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1509:     long save_rax = __read_reg("rax");
#APP
# 1509 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1511:     vmcall_4(det_sys_kill,current_task,save_pid,save_sig,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1511 "handlers.c" 1
...
.LFB92:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1518:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1519:     *save_pid=pid;
	mov	rax, QWORD PTR 40[rsp]	# save_pid, save_pid
	mov	QWORD PTR [rax], rdi	# *save_pid_4(D), pid
# handlers.c:1520:     *save_sig=sig;
	mov	rax, QWORD PTR 48[rsp]	# save_sig, save_sig
...
.LFB93:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1527:     long save_rax = __read_reg("rax");
#APP
# 1527 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1529:     vmcall_3(det_sys_fchdir,current_task,save_fd,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1529 "handlers.c" 1
...
# handlers.c:1543: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1544:     long save_rax = __read_reg("rax");
#APP
# 1544 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1546:     vmcall_4(det_sys_chmod,current_task,save_filename,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1546 "handlers.c" 1
...
.LFB96:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1553:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1554:     *save_filename=filename;
	mov	rax, QWORD PTR 40[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rdi	# *save_filename_4(D), filename
# handlers.c:1555:     *save_mode=mode;
...
.LFB97:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1562:     long save_rax = __read_reg("rax");
#APP
# 1562 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1564:     vmcall_5(det_sys_chown,current_task,save_filename,save_user,save_group,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1564 "handlers.c" 1
...
.LFB99:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1580:     long save_rax = __read_reg("rax");
#APP
# 1580 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1582:     vmcall_5(det_sys_fchmodat,current_task,save_dfd,save_filename,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1582 "handlers.c" 1
...
.LFB101:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1598:     long save_rax = __read_reg("rax");
#APP
# 1598 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1600:     vmcall_4(det_sys_fchmod,current_task,save_fd,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1600 "handlers.c" 1
...
.LFB102:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1607:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1608:     *save_fd=fd;
	mov	rax, QWORD PTR 40[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:1609:     *save_mode=mode;
	mov	rax, QWORD PTR 48[rsp]	# save_mode, save_mode
	mov	QWORD PTR [rax], rsi	# *save_mode_7(D), mode
# handlers.c:1610: }
	pop	rax	#
...
.LFB103:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1616:     long save_rax = __read_reg("rax");
#APP
# 1616 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1618:     vmcall_5(det_sys_fchown,current_task,save_fd,save_user,save_group,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1618 "handlers.c" 1
...
# handlers.c:1634: {
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:1635:     long save_rax = __read_reg("rax");
#APP
# 1635 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:1637:     vmcall_7(det_sys_fchownat,current_task,save_dfd,save_filename,save_user,save_group,save_flag,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1637 "handlers.c" 1
...
.LFB107:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1656:     long save_rax = __read_reg("rax");
#APP
# 1656 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1658:     vmcall_4(det_sys_rename,current_task,save_oldname,save_newname,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1658 "handlers.c" 1
...
.LFB108:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1665:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1666:     *save_oldname=oldname;
	mov	rax, QWORD PTR 40[rsp]	# save_oldname, save_oldname
	mov	QWORD PTR [rax], rdi	# *save_oldname_4(D), oldname
# handlers.c:1667:     *save_newname=newname;
...
.LFB109:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:1674:     long save_rax = __read_reg("rax");
#APP
# 1674 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:1676:     vmcall_7(det_sys_renameat2,current_task,save_olddfd,save_oldname,save_newdfd,save_newname,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1676 "handlers.c" 1
...
.LFB111:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1695:     long save_rax = __read_reg("rax");
#APP
# 1695 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1697:     vmcall_6(det_sys_renameat,current_task,save_olddfd,save_oldname,save_newdfd,save_newname,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1697 "handlers.c" 1
...
.LFB112:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1704:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1705:     *save_olddfd=olddfd;
	mov	rax, QWORD PTR 56[rsp]	# save_olddfd, save_olddfd
	mov	DWORD PTR [rax], edi	# *save_olddfd_4(D), olddfd
# handlers.c:1706:     *save_oldname=oldname;
	mov	rax, QWORD PTR 64[rsp]	# save_oldname, save_oldname
	mov	QWORD PTR [rax], rsi	# *save_oldname_7(D), oldname
# handlers.c:1707:     *save_newdfd=newdfd;
	mov	rax, QWORD PTR 72[rsp]	# save_newdfd, save_newdfd
	mov	DWORD PTR [rax], edx	# *save_newdfd_10(D), newdfd
# handlers.c:1708:     *save_newname=newname;
...
.LFB113:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1715:     long save_rax = __read_reg("rax");
#APP
# 1715 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1717:     vmcall_4(det_sys_mkdir,current_task,save_pathname,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1717 "handlers.c" 1
...
# handlers.c:1732: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1733:     long save_rax = __read_reg("rax");
#APP
# 1733 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1735:     vmcall_4(det_sys_creat,current_task,save_pathname,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1735 "handlers.c" 1
...
# handlers.c:1750: {
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1751:     long save_rax = __read_reg("rax");
#APP
# 1751 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1753:     vmcall_6(det_sys_openat,current_task,save_dfd,save_filename,save_flags,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1753 "handlers.c" 1
...
.LFB119:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1771:     long save_rax = __read_reg("rax");
#APP
# 1771 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1773:     vmcall_4(det_sys_link,current_task,save_oldname,save_newname,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1773 "handlers.c" 1
...
# handlers.c:1788: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1789:     long save_rax = __read_reg("rax");
#APP
# 1789 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1791:     vmcall_3(det_sys_unlink,current_task,save_pathname,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1791 "handlers.c" 1
...
# handlers.c:1805: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1806:     long save_rax = __read_reg("rax");
#APP
# 1806 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1808:     vmcall_5(det_sys_unlinkat,current_task,save_dfd,save_pathname,save_flag,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1808 "handlers.c" 1
...
.LFB124:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:1815:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1816:     *save_dfd=dfd;
	mov	rax, QWORD PTR 48[rsp]	# save_dfd, save_dfd
	mov	DWORD PTR [rax], edi	# *save_dfd_4(D), dfd
# handlers.c:1817:     *save_pathname=pathname;
	mov	rax, QWORD PTR 56[rsp]	# save_pathname, save_pathname
	mov	QWORD PTR [rax], rsi	# *save_pathname_7(D), pathname
# handlers.c:1818:     *save_flag=flag;
...
.LFB125:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:1825:     long save_rax = __read_reg("rax");
#APP
# 1825 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:1827:     vmcall_7(det_sys_linkat,current_task,save_olddfd,save_oldname,save_newdfd,save_newname,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1827 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1848:     vmcall_5(det_sys_symlinkat,current_task,save_oldname,save_newdfd,save_newname,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1848 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1867:     vmcall_4(det_sys_symlink,current_task,save_old,save_new,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1867 "handlers.c" 1
...
# handlers.c:1882: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1883:     long save_rax = __read_reg("rax");
#APP
# 1883 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1885:     vmcall_4(det_sys_access,current_task,save_filename,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1885 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1903:     vmcall_4(det_sys_fstat,current_task,save_fd,save_statbuf,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1903 "handlers.c" 1
...
# handlers.c:1918: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1919:     long save_rax = __read_reg("rax");
#APP
# 1919 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1921:     vmcall_4(det_sys_newstat,current_task,save_filename,save_statbuf,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1921 "handlers.c" 1
...
.LFB136:
	...
	.cfi_def_cfa_offset 32
	.cfi_offset 0, -32
# handlers.c:1928:     *skip_call=0;
	mov	rax, QWORD PTR 32[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1929:     *save_filename=filename;
	mov	rax, QWORD PTR 40[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rdi	# *save_filename_4(D), filename
# handlers.c:1930:     *save_statbuf=statbuf;
	mov	rax, QWORD PTR 48[rsp]	# save_statbuf, save_statbuf
...
.LFB137:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1937:     long save_rax = __read_reg("rax");
#APP
# 1937 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1939:     vmcall_4(det_sys_lstat,current_task,save_filename,save_statbuf,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1939 "handlers.c" 1
...
# handlers.c:1955: {
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1956:     long save_rax = __read_reg("rax");
#APP
# 1956 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1958:     vmcall_6(det_sys_newfstatat,current_task,save_dfd,save_filename,save_statbuf,save_flag,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1958 "handlers.c" 1
...
.LFB140:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1966:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1967:     *save_dfd=dfd;
	mov	rax, QWORD PTR 56[rsp]	# save_dfd, save_dfd
	mov	DWORD PTR [rax], edi	# *save_dfd_4(D), dfd
# handlers.c:1968:     *save_filename=filename;
	mov	rax, QWORD PTR 64[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rsi	# *save_filename_7(D), filename
# handlers.c:1969:     *save_statbuf=statbuf;
	mov	rax, QWORD PTR 72[rsp]	# save_statbuf, save_statbuf
	mov	QWORD PTR [rax], rdx	# *save_statbuf_10(D), statbuf
# handlers.c:1970:     *save_flag=flag;
...
# 0 "" 2
# handlers.c:1981:     vmcall_6(det_sys_pwrite64,current_task,save_fd,save_buf,save_count,save_pos,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1981 "handlers.c" 1
...
.LFB142:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1989:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1990:     *save_fd=fd;
	mov	rax, QWORD PTR 56[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:1991:     *save_buf=buf;
	mov	rax, QWORD PTR 64[rsp]	# save_buf, save_buf
	mov	QWORD PTR [rax], rsi	# *save_buf_7(D), buf
# handlers.c:1992:     *save_count=count;
	mov	rax, QWORD PTR 72[rsp]	# save_count, save_count
	mov	DWORD PTR [rax], edx	# *save_count_10(D), count
# handlers.c:1993:     *save_pos=pos;
...
.LFB143:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:2000:     long save_rax = __read_reg("rax");
#APP
# 2000 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:2002:     vmcall_6(det_sys_pread64,current_task,save_fd,save_buf,save_count,save_pos,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2002 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2023:     vmcall_8(det_sys_mmap_pgoff,current_task,save_addr,save_len,save_prot,save_flags,save_fd,save_pgoff,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2023 "handlers.c" 1
...
.LFB147:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:2046:     long save_rax = __read_reg("rax");
#APP
# 2046 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:2048:     vmcall_7(det_sys_prctl,current_task,save_option,save_arg2,save_arg3,save_arg4,save_arg5,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2048 "handlers.c" 1
...
.LFB149:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2068:     long save_rax = __read_reg("rax");
#APP
# 2068 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2070:     vmcall_5(det_do_sigaction,current_task,save_a,save_b,save_c,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2070 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2089:     vmcall_7(det_sys_select,current_task,save_n,save_inp,save_outp,save_exp,save_tvp,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2089 "handlers.c" 1
...
.LFB153:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:2108:     long save_rax = __read_reg("rax");
#APP
# 2108 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:2110:     vmcall_4(det_sys_clock_gettime,current_task,save_which_clock,save_tp,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2110 "handlers.c" 1
...
.LFB155:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:2127:     long save_rax = __read_reg("rax");
#APP
# 2127 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:2129:     vmcall_7(det_sys_clock_gettime,current_task,save_attr,save_pid,save_cpu,save_group_fd,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2129 "handlers.c" 1
...
.LFB157:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2149:     long save_rax = __read_reg("rax");
#APP
# 2149 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2151:     vmcall_3(det_sys_newuname,current_task,save_a,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2151 "handlers.c" 1
...
# handlers.c:2165: {
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:2166:     long save_rax = __read_reg("rax");
#APP
# 2166 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:2168:     vmcall_6(det_sys_reboot,current_task,save_magic1,save_magic2,save_cmd,save_arg,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2168 "handlers.c" 1
...
.LFB161:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2186:     long save_rax = __read_reg("rax");
#APP
# 2186 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2188:     vmcall_5(det_sys_init_module,current_task,save_umod,save_len,save_uargs,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2188 "handlers.c" 1
...
.LFB163:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:2205:     long save_rax = __read_reg("rax");
#APP
# 2205 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:2207:     vmcall_4(det_sys_delete_module,current_task,save_name_user,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2207 "handlers.c" 1
...
.LFB165:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2223:     long save_rax = __read_reg("rax");
#APP
# 2223 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2225:     vmcall_5(det_sys_finit_module,current_task,save_fd,save_uargs,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2225 "handlers.c" 1
...
# handlers.c:2242: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2243:     long save_rax = __read_reg("rax");
#APP
# 2243 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2244:     vmcall_5(det_sys_write,current_task,save_fd, save_buf, save_count,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2244 "handlers.c" 1
...
# handlers.c:2259: {
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2260:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2261:     *save_filename=filename;
	mov	rax, QWORD PTR 48[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rsi	# *save_filename_4(D), filename
# handlers.c:2262:     *save_flags=flags;
	mov	rax, QWORD PTR 56[rsp]	# save_flags, save_flags
	mov	DWORD PTR [rax], edx	# *save_flags_7(D), flags
# handlers.c:2263:     *save_mode=mode;
	mov	rax, QWORD PTR 64[rsp]	# save_mode, save_mode
...
.LFB170:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2270:     long save_rax = __read_reg("rax");
#APP
# 2270 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2271:     vmcall_5(det_do_sys_open, current_task, save_filename, save_flags,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2271 "handlers.c" 1
...
.LFB171:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2278:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2279:     *save_fd=fd;
	mov	rax, QWORD PTR 48[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2280:     *save_upeer_sockaddr=upeer_sockaddr;
...
# handlers.c:2281:     *save_upeer_addrlen=upeer_addrlen;
...
.LFB172:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2288:     long save_rax = __read_reg("rax");
#APP
# 2288 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2289:     vmcall_5(det_sys_accept, current_task, save_fd,save_upeer_sockaddr,save_upeer_addrlen,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2289 "handlers.c" 1
...
.LFB173:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2296:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2297:     *save_fd=fd;
	mov	rax, QWORD PTR 56[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2298:     *save_upeer_sockaddr=upeer_sockaddr;
	mov	rax, QWORD PTR 64[rsp]	# save_upeer_sockaddr, save_upeer_sockaddr
	mov	QWORD PTR [rax], rsi	# *save_upeer_sockaddr_7(D), upeer_sockaddr
# handlers.c:2299:     *save_upeer_addrlen=upeer_addrlen;
	mov	rax, QWORD PTR 72[rsp]	# save_upeer_addrlen, save_upeer_addrlen
	mov	QWORD PTR [rax], rdx	# *save_upeer_addrlen_10(D), upeer_addrlen
# handlers.c:2300:     *save_flags=flags;
...
.LFB174:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:2307:     long save_rax = __read_reg("rax");
#APP
# 2307 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:2308:     vmcall_6(det_sys_accept4, current_task, save_fd,save_upeer_sockaddr,save_upeer_addrlen,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2308 "handlers.c" 1
...
.LFB175:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2315:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2316:     *save_fd=fd;
	mov	rax, QWORD PTR 48[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2317:     *save_umyaddr=umyaddr;
	mov	rax, QWORD PTR 56[rsp]	# save_umyaddr, save_umyaddr
	mov	QWORD PTR [rax], rsi	# *save_umyaddr_7(D), umyaddr
# handlers.c:2318:     *save_addrlen=addrlen;
...
.LFB176:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2325:     long save_rax = __read_reg("rax");
#APP
# 2325 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2326:     vmcall_5(det_sys_bind, current_task, save_fd,save_umyaddr,save_addrlen,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2326 "handlers.c" 1
...
# handlers.c:2342: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2343:     long save_rax = __read_reg("rax");
#APP
# 2343 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2344:     vmcall_5(det_sys_connect, current_task, save_fd,save_uservaddr,save_addrlen,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2344 "handlers.c" 1
...
.LFB180:
	...
	.cfi_def_cfa_offset 88
	.cfi_offset 0, -88
# handlers.c:2368:     long save_rax = __read_reg("rax");
#APP
# 2368 "handlers.c" 1
	mov r15, rax	# val
	
# 0 "" 2
# handlers.c:2369:     vmcall_8(det_sys_sendto, current_task, save_fd,save_buff,save_len,save_flags,save_addr,save_addr_len,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2369 "handlers.c" 1
...
.LFB181:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2377:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2378:     *save_fd=fd;
	mov	rax, QWORD PTR 48[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2379:     *save_msg=msg;
	mov	rax, QWORD PTR 56[rsp]	# save_msg, save_msg
	mov	QWORD PTR [rax], rsi	# *save_msg_7(D), msg
# handlers.c:2380:     *save_flags=flags;
	mov	rax, QWORD PTR 64[rsp]	# save_flags, save_flags
	mov	DWORD PTR [rax], edx	# *save_flags_10(D), flags
# handlers.c:2381: }
	pop	rax	#
...
.LFB182:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2388:     long save_rax = __read_reg("rax");
#APP
# 2388 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2389:     vmcall_5(det_sys_sendmsg, current_task, save_fd,save_msg,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2389 "handlers.c" 1
...
.LFB183:
	...
	.cfi_def_cfa_offset 16
	.cfi_offset 9, -16
# handlers.c:2404:     *save_addr_len=addr_len;
...
.LFB184:
	...
	.cfi_def_cfa_offset 88
	.cfi_offset 0, -88
# handlers.c:2413:     long save_rax = __read_reg("rax");
#APP
# 2413 "handlers.c" 1
	mov r15, rax	# val
	
# 0 "" 2
# handlers.c:2414:     vmcall_8(det_sys_recvfrom, current_task, save_fd,save_ubuf,save_size,save_flags,save_addr,save_addr_len,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2414 "handlers.c" 1
...
# handlers.c:2432: {
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2433:     long save_rax = __read_reg("rax");
#APP
# 2433 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2434:     vmcall_5(det_sys_recvmsg, current_task, save_fd,save_msg,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2434 "handlers.c" 1
...
# handlers.c:2449: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2450:     long save_rax = __read_reg("rax");
#APP
# 2450 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2451:     vmcall_3(det_sys_close, current_task, save_fd,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2451 "handlers.c" 1
...
# handlers.c:2467: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2468:     long save_rax = __read_reg("rax");
#APP
# 2468 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2469:     vmcall_3(det_sys_dup, current_task, save_fildes,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2469 "handlers.c" 1
...
.LFB192:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:2487:     long save_rax = __read_reg("rax");
#APP
# 2487 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:2488:     vmcall_4(det_sys_dup2, current_task, save_oldfd,save_newfd,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2488 "handlers.c" 1
...
.LFB194:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:2527:     long save_rax = __read_reg("rax");
#APP
# 2527 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:2528:     vmcall_6(det_sys_dup2, current_task, save_pid,save_stat_addr,save_options,save_ru,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2528 "handlers.c" 1
...
.LFB196:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:2549:     long save_rax = __read_reg("rax");
#APP
# 2549 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:2550:     vmcall_7(det_sys_waitid, current_task, save_which,save_pid,save_infop,save_options,save_ru,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2550 "handlers.c" 1
...
# handlers.c:2568: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:2569:     long save_rax = __read_reg("rax");
#APP
# 2569 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:2570:     vmcall_4(det_sys_sched_rr_get_interval, current_task, save_pid,save_interval,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2570 "handlers.c" 1
...
.LFB199:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2578:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2579:     *save_filename=filename;
	mov	rax, QWORD PTR 48[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rdi	# *save_filename_4(D), filename
# handlers.c:2580:     *save_argv=argv;
	mov	rax, QWORD PTR 56[rsp]	# save_argv, save_argv
	mov	QWORD PTR [rax], rsi	# *save_argv_7(D), argv
# handlers.c:2581:     *save_envp=envp;
...
.LFB200:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2589:     long save_rax = __read_reg("rax");
#APP
# 2589 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2590:     vmcall_5(det_sys_execve, current_task,save_filename,save_argv,save_envp,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2590 "handlers.c" 1
...
.LFB202:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:2611:     long save_rax = __read_reg("rax");
#APP
# 2611 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:2612:     vmcall_7(det_sys_execveat, current_task,save_dfd,save_filename,save_argv,save_envp,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2612 "handlers.c" 1
...
.LFB203:
	...
	.cfi_def_cfa_offset 24
	.cfi_offset 0, -24
# handlers.c:2619:     *skip_call=0;
	mov	rax, QWORD PTR 24[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_3(D),
# handlers.c:2620:     *save_uid=uid;
...
.LFB204:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2628:     long save_rax = __read_reg("rax");
#APP
# 2628 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2629:     vmcall_3(det_sys_setuid16, current_task,save_uid,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2629 "handlers.c" 1
...
# handlers.c:2641: {
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2642:     long save_rax = __read_reg("rax");
#APP
# 2642 "handlers.c" 1
	mov r9, rax	# val
	
# 0 "" 2
# handlers.c:2643:     vmcall_2(det_sys_sched_yield, current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2643 "handlers.c" 1
...
.LFB207:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2651:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2652:     *save_fd=fd;
	mov	rax, QWORD PTR 56[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2653:     *save_msg=msg;
	mov	rax, QWORD PTR 64[rsp]	# save_msg, save_msg
	mov	QWORD PTR [rax], rsi	# *save_msg_7(D), msg
# handlers.c:2654:     *save_vlen=vlen;
	mov	rax, QWORD PTR 72[rsp]	# save_vlen, save_vlen
	mov	DWORD PTR [rax], edx	# *save_vlen_10(D), vlen
# handlers.c:2655:     *save_flags=flags;
	mov	rax, QWORD PTR 80[rsp]	# save_flags, save_flags
	mov	DWORD PTR [rax], ecx	# *save_flags_13(D), flags
# handlers.c:2656: }
	pop	rax	#
...
.LFB208:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:2664:     long save_rax = __read_reg("rax");
#APP
# 2664 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:2665:     vmcall_6(det_sys_sendmmsg, current_task,save_fd,save_msg,save_vlen,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2665 "handlers.c" 1
...
# handlers.c:2678: {
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2679:     long save_rax = __read_reg("rax");
#APP
# 2679 "handlers.c" 1
	mov r9, rax	# val
	
# 0 "" 2
# handlers.c:2680:     vmcall_2(det_sys_getpid, current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2680 "handlers.c" 1
...
# handlers.c:2693: {
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2694:     long save_rax = __read_reg("rax");
#APP
# 2694 "handlers.c" 1
	mov r9, rax	# val
	
# 0 "" 2
# handlers.c:2695:     vmcall_2(det_sys_gettid, current_task,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2695 "handlers.c" 1
...
# handlers.c:2709: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2710:     long save_rax = __read_reg("rax");
#APP
# 2710 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2711:     vmcall_3(det_sys_oldumount, current_task,save_name,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2711 "handlers.c" 1
...
# handlers.c:2725: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2726:     long save_rax = __read_reg("rax");
#APP
# 2726 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2727:     vmcall_3(det_sys_setgid16, current_task,save_gid,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2727 "handlers.c" 1
...
# handlers.c:2742: {
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:2743:     long save_rax = __read_reg("rax");
#APP
# 2743 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:2744:     vmcall_4(det_sys_getcwd, current_task,save_buf,save_size,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11904]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2744 "handlers.c" 1
...
.LFB219:
	.cfi_startproc
# handlers.c:3299:     def_detour_asm_vars(commit_creds);
#APP
# 3299 "handlers.c" 1
	#define commit_creds_jmp 96	#
# 0 "" 2
# handlers.c:3300:     def_detour_asm_vars(arch_jump_label_transform);
# 3300 "handlers.c" 1
	#define arch_jump_label_transform_jmp 192	#
# 0 "" 2
# handlers.c:3301:     def_detour_asm_vars(module_param_sysfs_setup);
# 3301 "handlers.c" 1
	#define module_param_sysfs_setup_jmp 288	#
# 0 "" 2
# handlers.c:3302:     def_detour_asm_vars(module_param_sysfs_remove);
# 3302 "handlers.c" 1
	#define module_param_sysfs_remove_jmp 384	#
# 0 "" 2
# handlers.c:3303:     def_detour_asm_vars(wake_up_new_task);
# 3303 "handlers.c" 1
	#define wake_up_new_task_jmp 480	#
# 0 "" 2
# handlers.c:3304:     def_detour_asm_vars(flush_old_exec);
# 3304 "handlers.c" 1
	#define flush_old_exec_jmp 576	#
# 0 "" 2
# handlers.c:3305:     def_detour_asm_vars(begin_new_exec);
# 3305 "handlers.c" 1
	#define begin_new_exec_jmp 672	#
# 0 "" 2
# handlers.c:3306:     def_detour_asm_vars(do_exit);
# 3306 "handlers.c" 1
	#define do_exit_jmp 768	#
# 0 "" 2
# handlers.c:3307:     def_detour_asm_vars(arch_ptrace);
# 3307 "handlers.c" 1
	#define arch_ptrace_jmp 864	#
# 0 "" 2
# handlers.c:3308:     def_detour_asm_vars(compat_arch_ptrace);
# 3308 "handlers.c" 1
	#define compat_arch_ptrace_jmp 960	#
# 0 "" 2
# handlers.c:3309:     def_detour_asm_vars(process_vm_rw_core);
# 3309 "handlers.c" 1
	#define process_vm_rw_core_jmp 1056	#
# 0 "" 2
# handlers.c:3310:     def_detour_asm_vars(__vma_link_rb);
# 3310 "handlers.c" 1
	#define __vma_link_rb_jmp 1152	#
# 0 "" 2
# handlers.c:3311:     def_detour_asm_vars(change_protection);
# 3311 "handlers.c" 1
	#define change_protection_jmp 1248	#
# 0 "" 2
# handlers.c:3312:     def_detour_asm_vars(vma_adjust);
# 3312 "handlers.c" 1
	#define vma_adjust_jmp 1344	#
# 0 "" 2
# handlers.c:3313:     def_detour_asm_vars(__vma_adjust);
# 3313 "handlers.c" 1
	#define __vma_adjust_jmp 1440	#
# 0 "" 2
# handlers.c:3314:     def_detour_asm_vars(vma_rb_erase);
# 3314 "handlers.c" 1
	#define vma_rb_erase_jmp 1536	#
# 0 "" 2
# handlers.c:3315:     def_detour_asm_vars(__vma_rb_erase);
# 3315 "handlers.c" 1
	#define __vma_rb_erase_jmp 1632	#
# 0 "" 2
# handlers.c:3316:     def_detour_asm_vars(expand_downwards);
# 3316 "handlers.c" 1
	#define expand_downwards_jmp 1728	#
# 0 "" 2
# handlers.c:3317:     def_detour_asm_vars(complete_signal);
# 3317 "handlers.c" 1
	#define complete_signal_jmp 1824	#
# 0 "" 2
# handlers.c:3318:     def_detour_asm_vars(text_poke);
# 3318 "handlers.c" 1
	#define text_poke_jmp 1920	#
# 0 "" 2
# handlers.c:3319:     def_detour_asm_vars(__text_poke);
# 3319 "handlers.c" 1
	#define __text_poke_jmp 2016	#
# 0 "" 2
# handlers.c:3320:     def_detour_asm_vars(ftrace_write);
# 3320 "handlers.c" 1
	#define ftrace_write_jmp 2112	#
# 0 "" 2
# handlers.c:3321:     def_detour_asm_vars(panic);
# 3321 "handlers.c" 1
	#define panic_jmp 2208	#
# 0 "" 2
# handlers.c:3322:     def_detour_asm_vars(crash_kexec);
# 3322 "handlers.c" 1
	#define crash_kexec_jmp 2304	#
# 0 "" 2
# handlers.c:3323:     def_detour_asm_vars(__access_remote_vm);
# 3323 "handlers.c" 1
	#define __access_remote_vm_jmp 2400	#
# 0 "" 2
# handlers.c:3325:     def_detour_hijack_asm_vars(mprotect_fixup, vma_wants_writenotify);
# 3325 "handlers.c" 1
	#define mprotect_fixup_vma_wants_writenotify_jmp 2496	#
# 0 "" 2
# handlers.c:3326:     def_detour_hijack_asm_vars(do_munmap, rb_erase);
# 3326 "handlers.c" 1
	#define do_munmap_rb_erase_jmp 2592	#
# 0 "" 2
# handlers.c:3327:     def_detour_hijack_asm_vars(vma_adjust, rb_erase);
# 3327 "handlers.c" 1
	#define vma_adjust_rb_erase_jmp 2688	#
# 0 "" 2
# handlers.c:3329:     def_detour_asm_vars(do_rmdir);
# 3329 "handlers.c" 1
	#define do_rmdir_jmp 2784	#
# 0 "" 2
# handlers.c:3330:     def_detour_asm_vars(sys_sysfs);
# 3330 "handlers.c" 1
	#define sys_sysfs_jmp 2880	#
# 0 "" 2
# handlers.c:3331:     def_detour_asm_vars(sys_read);
# 3331 "handlers.c" 1
	#define sys_read_jmp 2976	#
# 0 "" 2
# handlers.c:3332:     def_detour_asm_vars(sys_getppid);
# 3332 "handlers.c" 1
	#define sys_getppid_jmp 3072	#
# 0 "" 2
# handlers.c:3333:     def_detour_asm_vars(sys_getsid);
# 3333 "handlers.c" 1
	#define sys_getsid_jmp 3168	#
# 0 "" 2
# handlers.c:3334:     def_detour_asm_vars(sys_getuid);
# 3334 "handlers.c" 1
	#define sys_getuid_jmp 3264	#
# 0 "" 2
# handlers.c:3335:     def_detour_asm_vars(sys_geteuid);
# 3335 "handlers.c" 1
	#define sys_geteuid_jmp 3360	#
# 0 "" 2
# handlers.c:3336:     def_detour_asm_vars(sys_shutdown);
# 3336 "handlers.c" 1
	#define sys_shutdown_jmp 3456	#
# 0 "" 2
# handlers.c:3337:     def_detour_asm_vars(do_sysinfo);
# 3337 "handlers.c" 1
	#define do_sysinfo_jmp 3552	#
# 0 "" 2
# handlers.c:3338:     def_detour_asm_vars(sys_capget);
# 3338 "handlers.c" 1
	#define sys_capget_jmp 3648	#
# 0 "" 2
# handlers.c:3339:     def_detour_asm_vars(sys_capset);
# 3339 "handlers.c" 1
	#define sys_capset_jmp 3744	#
# 0 "" 2
# handlers.c:3340:     def_detour_asm_vars(sys_statfs);
# 3340 "handlers.c" 1
	#define sys_statfs_jmp 3840	#
# 0 "" 2
# handlers.c:3341:     def_detour_asm_vars(sys_fstatfs);
# 3341 "handlers.c" 1
	#define sys_fstatfs_jmp 3936	#
# 0 "" 2
# handlers.c:3342:     def_detour_asm_vars(sys_setsid);
# 3342 "handlers.c" 1
	#define sys_setsid_jmp 4032	#
# 0 "" 2
# handlers.c:3343:     def_detour_asm_vars(sys_seccomp);
# 3343 "handlers.c" 1
	#define sys_seccomp_jmp 4128	#
# 0 "" 2
# handlers.c:3344:     def_detour_asm_vars(sys_tgkill);
# 3344 "handlers.c" 1
	#define sys_tgkill_jmp 4224	#
# 0 "" 2
# handlers.c:3345:     def_detour_asm_vars(sys_tkill);
# 3345 "handlers.c" 1
	#define sys_tkill_jmp 4320	#
# 0 "" 2
# handlers.c:3346:     def_detour_asm_vars(sys_ustat);
# 3346 "handlers.c" 1
	#define sys_ustat_jmp 4416	#
# 0 "" 2
# handlers.c:3347:     def_detour_asm_vars(sys_poll);
# 3347 "handlers.c" 1
	#define sys_poll_jmp 4512	#
# 0 "" 2
# handlers.c:3348:     def_detour_asm_vars(sys_sigprocmask);
# 3348 "handlers.c" 1
	#define sys_sigprocmask_jmp 4608	#
# 0 "" 2
# handlers.c:3349:     def_detour_asm_vars(sys_getrlimit);
# 3349 "handlers.c" 1
	#define sys_getrlimit_jmp 4704	#
# 0 "" 2
# handlers.c:3350:     def_detour_asm_vars(sys_umask);
# 3350 "handlers.c" 1
	#define sys_umask_jmp 4800	#
# 0 "" 2
# handlers.c:3351:     def_detour_asm_vars(sys_ioctl);
# 3351 "handlers.c" 1
	#define sys_ioctl_jmp 4896	#
# 0 "" 2
# handlers.c:3352:     def_detour_asm_vars(sys_brk);
# 3352 "handlers.c" 1
	#define sys_brk_jmp 4992	#
# 0 "" 2
# handlers.c:3353:     def_detour_asm_vars(sys_gettimeofday);
# 3353 "handlers.c" 1
	#define sys_gettimeofday_jmp 5088	#
# 0 "" 2
# handlers.c:3354:     def_detour_asm_vars(sys_setresuid);
# 3354 "handlers.c" 1
	#define sys_setresuid_jmp 5184	#
# 0 "" 2
# handlers.c:3355:     def_detour_asm_vars(sys_chdir);
# 3355 "handlers.c" 1
	#define sys_chdir_jmp 5280	#
# 0 "" 2
# handlers.c:3356:     def_detour_asm_vars(sys_alarm);
# 3356 "handlers.c" 1
	#define sys_alarm_jmp 5376	#
# 0 "" 2
# handlers.c:3357:     def_detour_asm_vars(sys_ptrace);
# 3357 "handlers.c" 1
	#define sys_ptrace_jmp 5472	#
# 0 "" 2
# handlers.c:3358:     def_detour_asm_vars(sys_time);
# 3358 "handlers.c" 1
	#define sys_time_jmp 5568	#
# 0 "" 2
# handlers.c:3359:     def_detour_asm_vars(sys_chroot);
# 3359 "handlers.c" 1
	#define sys_chroot_jmp 5664	#
# 0 "" 2
# handlers.c:3360:     def_detour_asm_vars(sys_kill);
# 3360 "handlers.c" 1
	#define sys_kill_jmp 5760	#
# 0 "" 2
# handlers.c:3361:     def_detour_asm_vars(sys_fchdir);
# 3361 "handlers.c" 1
	#define sys_fchdir_jmp 5856	#
# 0 "" 2
# handlers.c:3362:     def_detour_asm_vars(sys_chmod);
# 3362 "handlers.c" 1
	#define sys_chmod_jmp 5952	#
# 0 "" 2
# handlers.c:3363:     def_detour_asm_vars(sys_chown);
# 3363 "handlers.c" 1
	#define sys_chown_jmp 6048	#
# 0 "" 2
# handlers.c:3364:     def_detour_asm_vars(sys_fchmodat);
# 3364 "handlers.c" 1
	#define sys_fchmodat_jmp 6144	#
# 0 "" 2
# handlers.c:3365:     def_detour_asm_vars(sys_fchmod);
# 3365 "handlers.c" 1
	#define sys_fchmod_jmp 6240	#
# 0 "" 2
# handlers.c:3366:     def_detour_asm_vars(sys_fchown);
# 3366 "handlers.c" 1
	#define sys_fchown_jmp 6336	#
# 0 "" 2
# handlers.c:3367:     def_detour_asm_vars(sys_fchownat);
# 3367 "handlers.c" 1
	#define sys_fchownat_jmp 6432	#
# 0 "" 2
# handlers.c:3368:     def_detour_asm_vars(sys_rename);
# 3368 "handlers.c" 1
	#define sys_rename_jmp 6528	#
# 0 "" 2
# handlers.c:3369:     def_detour_asm_vars(sys_renameat2);
# 3369 "handlers.c" 1
	#define sys_renameat2_jmp 6624	#
# 0 "" 2
# handlers.c:3370:     def_detour_asm_vars(sys_renameat);
# 3370 "handlers.c" 1
	#define sys_renameat_jmp 6720	#
# 0 "" 2
# handlers.c:3371:     def_detour_asm_vars(sys_mkdir);
# 3371 "handlers.c" 1
	#define sys_mkdir_jmp 6816	#
# 0 "" 2
# handlers.c:3372:     def_detour_asm_vars(sys_creat);
# 3372 "handlers.c" 1
	#define sys_creat_jmp 6912	#
# 0 "" 2
# handlers.c:3373:     def_detour_asm_vars(sys_openat);
# 3373 "handlers.c" 1
	#define sys_openat_jmp 7008	#
# 0 "" 2
# handlers.c:3374:     def_detour_asm_vars(sys_link);
# 3374 "handlers.c" 1
	#define sys_link_jmp 7104	#
# 0 "" 2
# handlers.c:3375:     def_detour_asm_vars(sys_unlink);
# 3375 "handlers.c" 1
	#define sys_unlink_jmp 7200	#
# 0 "" 2
# handlers.c:3376:     def_detour_asm_vars(sys_unlinkat);
# 3376 "handlers.c" 1
	#define sys_unlinkat_jmp 7296	#
# 0 "" 2
# handlers.c:3377:     def_detour_asm_vars(sys_linkat);
# 3377 "handlers.c" 1
	#define sys_linkat_jmp 7392	#
# 0 "" 2
# handlers.c:3378:     def_detour_asm_vars(sys_symlink);
# 3378 "handlers.c" 1
	#define sys_symlink_jmp 7488	#
# 0 "" 2
# handlers.c:3379:     def_detour_asm_vars(sys_symlinkat);
# 3379 "handlers.c" 1
	#define sys_symlinkat_jmp 7584	#
# 0 "" 2
# handlers.c:3380:     def_detour_asm_vars(sys_access);
# 3380 "handlers.c" 1
	#define sys_access_jmp 7680	#
# 0 "" 2
# handlers.c:3381:     def_detour_asm_vars(sys_fstat);
# 3381 "handlers.c" 1
	#define sys_fstat_jmp 7776	#
# 0 "" 2
# handlers.c:3382:     def_detour_asm_vars(sys_newstat);
# 3382 "handlers.c" 1
	#define sys_newstat_jmp 7872	#
# 0 "" 2
# handlers.c:3383:     def_detour_asm_vars(sys_lstat);
# 3383 "handlers.c" 1
	#define sys_lstat_jmp 7968	#
# 0 "" 2
# handlers.c:3384:     def_detour_asm_vars(sys_newfstatat);
# 3384 "handlers.c" 1
	#define sys_newfstatat_jmp 8064	#
# 0 "" 2
# handlers.c:3385:     def_detour_asm_vars(sys_pwrite64);
# 3385 "handlers.c" 1
	#define sys_pwrite64_jmp 8160	#
# 0 "" 2
# handlers.c:3386:     def_detour_asm_vars(sys_pread64);
# 3386 "handlers.c" 1
	#define sys_pread64_jmp 8256	#
# 0 "" 2
# handlers.c:3387:     def_detour_asm_vars(sys_mmap_pgoff);
# 3387 "handlers.c" 1
	#define sys_mmap_pgoff_jmp 8352	#
# 0 "" 2
# handlers.c:3388:     def_detour_asm_vars(sys_prctl);
# 3388 "handlers.c" 1
	#define sys_prctl_jmp 8448	#
# 0 "" 2
# handlers.c:3389:     def_detour_asm_vars(do_sigaction);
# 3389 "handlers.c" 1
	#define do_sigaction_jmp 8544	#
# 0 "" 2
# handlers.c:3390:     def_detour_asm_vars(sys_select);
# 3390 "handlers.c" 1
	#define sys_select_jmp 8640	#
# 0 "" 2
# handlers.c:3391:     def_detour_asm_vars(sys_clock_gettime);
# 3391 "handlers.c" 1
	#define sys_clock_gettime_jmp 8736	#
# 0 "" 2
# handlers.c:3392:     def_detour_asm_vars(sys_perf_event_open);
# 3392 "handlers.c" 1
	#define sys_perf_event_open_jmp 8832	#
# 0 "" 2
# handlers.c:3393:     def_detour_asm_vars(sys_newuname);
# 3393 "handlers.c" 1
	#define sys_newuname_jmp 8928	#
# 0 "" 2
# handlers.c:3394:     def_detour_asm_vars(sys_reboot);
# 3394 "handlers.c" 1
	#define sys_reboot_jmp 9024	#
# 0 "" 2
# handlers.c:3395:     def_detour_asm_vars(sys_init_module);
# 3395 "handlers.c" 1
	#define sys_init_module_jmp 9120	#
# 0 "" 2
# handlers.c:3396:     def_detour_asm_vars(sys_delete_module);
# 3396 "handlers.c" 1
	#define sys_delete_module_jmp 9216	#
# 0 "" 2
# handlers.c:3397:     def_detour_asm_vars(sys_finit_module);
# 3397 "handlers.c" 1
	#define sys_finit_module_jmp 9312	#
# 0 "" 2
# handlers.c:3398:     def_detour_asm_vars(sys_write);
# 3398 "handlers.c" 1
	#define sys_write_jmp 9408	#
# 0 "" 2
# handlers.c:3399:     def_detour_asm_vars(do_sys_open);
# 3399 "handlers.c" 1
	#define do_sys_open_jmp 9504	#
# 0 "" 2
# handlers.c:3400:     def_detour_asm_vars(sys_accept);
# 3400 "handlers.c" 1
	#define sys_accept_jmp 9600	#
# 0 "" 2
# handlers.c:3401:     def_detour_asm_vars(sys_accept4);
# 3401 "handlers.c" 1
	#define sys_accept4_jmp 9696	#
# 0 "" 2
# handlers.c:3402:     def_detour_asm_vars(sys_bind);
# 3402 "handlers.c" 1
	#define sys_bind_jmp 9792	#
# 0 "" 2
# handlers.c:3403:     def_detour_asm_vars(sys_connect);
# 3403 "handlers.c" 1
	#define sys_connect_jmp 9888	#
# 0 "" 2
# handlers.c:3404:     def_detour_asm_vars(sys_sendto);
# 3404 "handlers.c" 1
	#define sys_sendto_jmp 9984	#
# 0 "" 2
# handlers.c:3405:     def_detour_asm_vars(sys_sendmsg);
# 3405 "handlers.c" 1
	#define sys_sendmsg_jmp 10080	#
# 0 "" 2
# handlers.c:3406:     def_detour_asm_vars(sys_recvmsg);
# 3406 "handlers.c" 1
	#define sys_recvmsg_jmp 10272	#
# 0 "" 2
# handlers.c:3407:     def_detour_asm_vars(sys_recvfrom);
# 3407 "handlers.c" 1
	#define sys_recvfrom_jmp 10176	#
# 0 "" 2
# handlers.c:3408:     def_detour_asm_vars(sys_close);
# 3408 "handlers.c" 1
	#define sys_close_jmp 10560	#
# 0 "" 2
# handlers.c:3409:     def_detour_asm_vars(sys_dup);
# 3409 "handlers.c" 1
	#define sys_dup_jmp 10368	#
# 0 "" 2
# handlers.c:3410:     def_detour_asm_vars(sys_dup2);
# 3410 "handlers.c" 1
	#define sys_dup2_jmp 10464	#
# 0 "" 2
# handlers.c:3412:     def_detour_asm_vars(sys_waitid);
# 3412 "handlers.c" 1
	#define sys_waitid_jmp 10656	#
# 0 "" 2
# handlers.c:3413:     def_detour_asm_vars(sys_wait4);
# 3413 "handlers.c" 1
	#define sys_wait4_jmp 10752	#
# 0 "" 2
# handlers.c:3414:     def_detour_asm_vars(sys_sched_rr_get_interval);
# 3414 "handlers.c" 1
	#define sys_sched_rr_get_interval_jmp 10848	#
# 0 "" 2
# handlers.c:3415:     def_detour_asm_vars(sys_execve);
# 3415 "handlers.c" 1
	#define sys_execve_jmp 10944	#
# 0 "" 2
# handlers.c:3416:     def_detour_asm_vars(sys_execveat);
# 3416 "handlers.c" 1
	#define sys_execveat_jmp 11040	#
# 0 "" 2
# handlers.c:3417:     def_detour_asm_vars(sys_setuid16);
# 3417 "handlers.c" 1
	#define sys_setuid16_jmp 11136	#
# 0 "" 2
# handlers.c:3418:     def_detour_asm_vars(sys_sched_yield);
# 3418 "handlers.c" 1
	#define sys_sched_yield_jmp 11232	#
# 0 "" 2
# handlers.c:3419:     def_detour_asm_vars(sys_sendmmsg);
# 3419 "handlers.c" 1
	#define sys_sendmmsg_jmp 11328	#
# 0 "" 2
# handlers.c:3420:     def_detour_asm_vars(sys_getpid);
# 3420 "handlers.c" 1
	#define sys_getpid_jmp 11424	#
# 0 "" 2
# handlers.c:3421:     def_detour_asm_vars(sys_gettid);
# 3421 "handlers.c" 1
	#define sys_gettid_jmp 11520	#
# 0 "" 2
# handlers.c:3422:     def_detour_asm_vars(sys_oldumount);
# 3422 "handlers.c" 1
	#define sys_oldumount_jmp 11616	#
# 0 "" 2
# handlers.c:3423:     def_detour_asm_vars(sys_setgid16);
# 3423 "handlers.c" 1
	#define sys_setgid16_jmp 11712	#
# 0 "" 2
# handlers.c:3424:     def_detour_asm_vars(sys_getcwd);
# 3424 "handlers.c" 1
