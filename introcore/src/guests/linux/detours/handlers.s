...
.L14:
# handlers.c:333:     while (len--)
	cmp	rdx, rcx	# len, ivtmp.484
	je	.L17	#,
# handlers.c:335:         *d++ = *s++;
	mov	dil, BYTE PTR [rsi+rcx]	# _1, MEM[base: src_7(D), index: ivtmp.484_14, offset: 0B]
	mov	BYTE PTR [rax+rcx], dil	# MEM[base: dest_6(D), index: ivtmp.484_14, offset: 0B], _1
	inc	rcx	# ivtmp.484
	jmp	.L14	#
.L17:
# handlers.c:339: }
...
# 0 "" 2
# handlers.c:1724:     vmcall_6(det_sys_newfstatat,current_task,save_dfd,save_filename,save_statbuf,save_flag,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1724 "handlers.c" 1
...
.LFB140:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1732:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1733:     *save_dfd=dfd;
	mov	rax, QWORD PTR 56[rsp]	# save_dfd, save_dfd
	mov	DWORD PTR [rax], edi	# *save_dfd_4(D), dfd
# handlers.c:1734:     *save_filename=filename;
	mov	rax, QWORD PTR 64[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rsi	# *save_filename_7(D), filename
# handlers.c:1735:     *save_statbuf=statbuf;
	mov	rax, QWORD PTR 72[rsp]	# save_statbuf, save_statbuf
	mov	QWORD PTR [rax], rdx	# *save_statbuf_10(D), statbuf
# handlers.c:1736:     *save_flag=flag;
...
.LFB141:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1745:     long save_rax = __read_reg("rax");
#APP
# 1745 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1747:     vmcall_6(det_sys_pwrite64,current_task,save_fd,save_buf,save_count,save_pos,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1747 "handlers.c" 1
...
.LFB142:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1755:     *skip_call=0;
	mov	rax, QWORD PTR 48[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:1756:     *save_fd=fd;
	mov	rax, QWORD PTR 56[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:1757:     *save_buf=buf;
	mov	rax, QWORD PTR 64[rsp]	# save_buf, save_buf
	mov	QWORD PTR [rax], rsi	# *save_buf_7(D), buf
# handlers.c:1758:     *save_count=count;
	mov	rax, QWORD PTR 72[rsp]	# save_count, save_count
	mov	DWORD PTR [rax], edx	# *save_count_10(D), count
# handlers.c:1759:     *save_pos=pos;
...
.LFB143:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1766:     long save_rax = __read_reg("rax");
#APP
# 1766 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1768:     vmcall_6(det_sys_pread64,current_task,save_fd,save_buf,save_count,save_pos,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1768 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1789:     vmcall_8(det_sys_mmap_pgoff,current_task,save_addr,save_len,save_prot,save_flags,save_fd,save_pgoff,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1789 "handlers.c" 1
...
.LFB147:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:1812:     long save_rax = __read_reg("rax");
#APP
# 1812 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:1814:     vmcall_7(det_sys_prctl,current_task,save_option,save_arg2,save_arg3,save_arg4,save_arg5,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1814 "handlers.c" 1
...
.LFB149:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:1834:     long save_rax = __read_reg("rax");
#APP
# 1834 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:1836:     vmcall_5(det_do_sigaction,current_task,save_a,save_b,save_c,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1836 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1855:     vmcall_7(det_sys_select,current_task,save_n,save_inp,save_outp,save_exp,save_tvp,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1855 "handlers.c" 1
...
.LFB153:
	...
	.cfi_def_cfa_offset 56
	.cfi_offset 0, -56
# handlers.c:1874:     long save_rax = __read_reg("rax");
#APP
# 1874 "handlers.c" 1
	mov r11, rax	# val
	
# 0 "" 2
# handlers.c:1876:     vmcall_4(det_sys_clock_gettime,current_task,save_which_clock,save_tp,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1876 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1895:     vmcall_7(det_sys_clock_gettime,current_task,save_attr,save_pid,save_cpu,save_group_fd,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1895 "handlers.c" 1
...
.LFB157:
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:1915:     long save_rax = __read_reg("rax");
#APP
# 1915 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:1917:     vmcall_3(det_sys_newuname,current_task,save_a,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1917 "handlers.c" 1
...
# handlers.c:1931: {
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:1932:     long save_rax = __read_reg("rax");
#APP
# 1932 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:1934:     vmcall_6(det_sys_reboot,current_task,save_magic1,save_magic2,save_cmd,save_arg,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1934 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1954:     vmcall_5(det_sys_init_module,current_task,save_umod,save_len,save_uargs,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1954 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1973:     vmcall_4(det_sys_delete_module,current_task,save_name_user,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1973 "handlers.c" 1
...
# 0 "" 2
# handlers.c:1991:     vmcall_5(det_sys_finit_module,current_task,save_fd,save_uargs,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 1991 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2010:     vmcall_5(det_sys_write,current_task,save_fd, save_buf, save_count,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2010 "handlers.c" 1
...
# handlers.c:2025: {
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2026:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2027:     *save_filename=filename;
	mov	rax, QWORD PTR 48[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rsi	# *save_filename_4(D), filename
# handlers.c:2028:     *save_flags=flags;
	mov	rax, QWORD PTR 56[rsp]	# save_flags, save_flags
	mov	DWORD PTR [rax], edx	# *save_flags_7(D), flags
# handlers.c:2029:     *save_mode=mode;
	mov	rax, QWORD PTR 64[rsp]	# save_mode, save_mode
...
.LFB170:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2036:     long save_rax = __read_reg("rax");
#APP
# 2036 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2037:     vmcall_5(det_do_sys_open, current_task, save_filename, save_flags,save_mode,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2037 "handlers.c" 1
...
# handlers.c:2044:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2045:     *save_fd=fd;
	mov	rax, QWORD PTR 48[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2046:     *save_upeer_sockaddr=upeer_sockaddr;
...
# handlers.c:2047:     *save_upeer_addrlen=upeer_addrlen;
...
# 0 "" 2
# handlers.c:2055:     vmcall_5(det_sys_accept, current_task, save_fd,save_upeer_sockaddr,save_upeer_addrlen,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2055 "handlers.c" 1
...
# handlers.c:2065:     *save_upeer_addrlen=upeer_addrlen;
	...
	mov	QWORD PTR [rax], rdx	# *save_upeer_addrlen_10(D), upeer_addrlen
# handlers.c:2066:     *save_flags=flags;
...
# 0 "" 2
# handlers.c:2074:     vmcall_6(det_sys_accept4, current_task, save_fd,save_upeer_sockaddr,save_upeer_addrlen,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2074 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2092:     vmcall_5(det_sys_bind, current_task, save_fd,save_umyaddr,save_addrlen,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2092 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2110:     vmcall_5(det_sys_connect, current_task, save_fd,save_uservaddr,save_addrlen,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2110 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2135:     vmcall_8(det_sys_sendto, current_task, save_fd,save_buff,save_len,save_flags,save_addr,save_addr_len,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2135 "handlers.c" 1
...
.LFB181:
	...
	.cfi_def_cfa_offset 40
	.cfi_offset 0, -40
# handlers.c:2143:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2144:     *save_fd=fd;
	mov	rax, QWORD PTR 48[rsp]	# save_fd, save_fd
	mov	DWORD PTR [rax], edi	# *save_fd_4(D), fd
# handlers.c:2145:     *save_msg=msg;
...
# 0 "" 2
# handlers.c:2155:     vmcall_5(det_sys_sendmsg, current_task, save_fd,save_msg,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2155 "handlers.c" 1
...
.LFB183:
	...
	.cfi_def_cfa_offset 16
	.cfi_offset 9, -16
# handlers.c:2170:     *save_addr_len=addr_len;
...
.LFB184:
	...
	.cfi_def_cfa_offset 88
	.cfi_offset 0, -88
# handlers.c:2179:     long save_rax = __read_reg("rax");
#APP
# 2179 "handlers.c" 1
	mov r15, rax	# val
	
# 0 "" 2
# handlers.c:2180:     vmcall_8(det_sys_recvfrom, current_task, save_fd,save_ubuf,save_size,save_flags,save_addr,save_addr_len,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2180 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2200:     vmcall_5(det_sys_recvmsg, current_task, save_fd,save_msg,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2200 "handlers.c" 1
...
# handlers.c:2215: {
	...
	.cfi_def_cfa_offset 48
	.cfi_offset 0, -48
# handlers.c:2216:     long save_rax = __read_reg("rax");
#APP
# 2216 "handlers.c" 1
	mov r10, rax	# val
	
# 0 "" 2
# handlers.c:2217:     vmcall_3(det_sys_close, current_task, save_fd,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2217 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2235:     vmcall_3(det_sys_dup, current_task, save_fildes,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2235 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2254:     vmcall_4(det_sys_dup2, current_task, save_oldfd,save_newfd,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2254 "handlers.c" 1
...
# handlers.c:2263:     *save_newfd=save_newfd;
	mov	DWORD PTR [rax], eax	# *save_newfd_9(D), save_newfd
# handlers.c:2264:     *save_flags=flags;
	mov	rax, QWORD PTR 64[rsp]	# save_flags, save_flags
	mov	DWORD PTR [rax], edx	# *save_flags_11(D), flags
# handlers.c:2265: }
	pop	rax	#
...
# 0 "" 2
# handlers.c:2273:     vmcall_5(det_sys_dup2, current_task, save_oldfd,save_newfd,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2273 "handlers.c" 1
...
.LFB196:
	...
	.cfi_def_cfa_offset 72
	.cfi_offset 0, -72
# handlers.c:2293:     long save_rax = __read_reg("rax");
#APP
# 2293 "handlers.c" 1
	mov r13, rax	# val
	
# 0 "" 2
# handlers.c:2294:     vmcall_6(det_sys_dup2, current_task, save_pid,save_stat_addr,save_options,save_ru,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2294 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2316:     vmcall_7(det_sys_waitid, current_task, save_which,save_pid,save_infop,save_options,save_ru,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2316 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2336:     vmcall_4(det_sys_sched_rr_get_interval, current_task, save_pid,save_interval,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2336 "handlers.c" 1
...
# handlers.c:2344:     *skip_call=0;
	mov	rax, QWORD PTR 40[rsp]	# skip_call, skip_call
	mov	QWORD PTR [rax], 0	# *skip_call_2(D),
# handlers.c:2345:     *save_filename=filename;
	mov	rax, QWORD PTR 48[rsp]	# save_filename, save_filename
	mov	QWORD PTR [rax], rdi	# *save_filename_4(D), filename
# handlers.c:2346:     *save_argv=argv;
	mov	rax, QWORD PTR 56[rsp]	# save_argv, save_argv
	mov	QWORD PTR [rax], rsi	# *save_argv_7(D), argv
# handlers.c:2347:     *save_envp=envp;
...
.LFB202:
	...
	.cfi_def_cfa_offset 64
	.cfi_offset 0, -64
# handlers.c:2355:     long save_rax = __read_reg("rax");
#APP
# 2355 "handlers.c" 1
	mov r12, rax	# val
	
# 0 "" 2
# handlers.c:2356:     vmcall_5(det_sys_execve, current_task,save_filename,save_argv,save_envp,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2356 "handlers.c" 1
...
.LFB204:
	...
	.cfi_def_cfa_offset 80
	.cfi_offset 0, -80
# handlers.c:2376:     long save_rax = __read_reg("rax");
#APP
# 2376 "handlers.c" 1
	mov r14, rax	# val
	
# 0 "" 2
# handlers.c:2377:     vmcall_7(det_sys_execveat, current_task,save_dfd,save_filename,save_argv,save_envp,save_flags,save_rax);
#NO_APP
	mov	r8d, DWORD PTR hypercall_info[rip+11232]	# hypercall_info.OsSpecificFields.CurrentTaskOffset, hypercall_info.OsSpecificFields.CurrentTaskOffset
#APP
# 2377 "handlers.c" 1
...
# 0 "" 2
# handlers.c:2469:     def_detour_asm_vars(sys_newfstatat);
# 2469 "handlers.c" 1
	#define sys_newfstatat_jmp 8064	#
# 0 "" 2
# handlers.c:2470:     def_detour_asm_vars(sys_pwrite64);
# 2470 "handlers.c" 1
	#define sys_pwrite64_jmp 8160	#
# 0 "" 2
# handlers.c:2471:     def_detour_asm_vars(sys_pread64);
# 2471 "handlers.c" 1
	#define sys_pread64_jmp 8256	#
# 0 "" 2
# handlers.c:2472:     def_detour_asm_vars(sys_mmap_pgoff);
# 2472 "handlers.c" 1
	#define sys_mmap_pgoff_jmp 8352	#
# 0 "" 2
# handlers.c:2473:     def_detour_asm_vars(sys_prctl);
# 2473 "handlers.c" 1
	#define sys_prctl_jmp 8448	#
# 0 "" 2
# handlers.c:2474:     def_detour_asm_vars(do_sigaction);
# 2474 "handlers.c" 1
	#define do_sigaction_jmp 8544	#
# 0 "" 2
# handlers.c:2475:     def_detour_asm_vars(sys_select);
# 2475 "handlers.c" 1
	#define sys_select_jmp 8640	#
# 0 "" 2
# handlers.c:2476:     def_detour_asm_vars(sys_clock_gettime);
# 2476 "handlers.c" 1
	#define sys_clock_gettime_jmp 8736	#
# 0 "" 2
# handlers.c:2477:     def_detour_asm_vars(sys_perf_event_open);
# 2477 "handlers.c" 1
	#define sys_perf_event_open_jmp 8832	#
# 0 "" 2
# handlers.c:2478:     def_detour_asm_vars(sys_newuname);
# 2478 "handlers.c" 1
	#define sys_newuname_jmp 8928	#
# 0 "" 2
# handlers.c:2479:     def_detour_asm_vars(sys_reboot);
# 2479 "handlers.c" 1
	#define sys_reboot_jmp 9024	#
# 0 "" 2
# handlers.c:2480:     def_detour_asm_vars(sys_init_module);
# 2480 "handlers.c" 1
	#define sys_init_module_jmp 9120	#
# 0 "" 2
# handlers.c:2481:     def_detour_asm_vars(sys_delete_module);
# 2481 "handlers.c" 1
	#define sys_delete_module_jmp 9216	#
# 0 "" 2
# handlers.c:2482:     def_detour_asm_vars(sys_finit_module);
# 2482 "handlers.c" 1
	#define sys_finit_module_jmp 9312	#
# 0 "" 2
# handlers.c:2483:     def_detour_asm_vars(sys_write);
# 2483 "handlers.c" 1
	#define sys_write_jmp 9408	#
# 0 "" 2
# handlers.c:2484:     def_detour_asm_vars(do_sys_open);
# 2484 "handlers.c" 1
	#define do_sys_open_jmp 9504	#
# 0 "" 2
# handlers.c:2485:     def_detour_asm_vars(sys_accept);
# 2485 "handlers.c" 1
	#define sys_accept_jmp 9600	#
# 0 "" 2
# handlers.c:2486:     def_detour_asm_vars(sys_accept4);
# 2486 "handlers.c" 1
	#define sys_accept4_jmp 9696	#
# 0 "" 2
# handlers.c:2487:     def_detour_asm_vars(sys_bind);
# 2487 "handlers.c" 1
	#define sys_bind_jmp 9792	#
# 0 "" 2
# handlers.c:2488:     def_detour_asm_vars(sys_connect);
# 2488 "handlers.c" 1
	#define sys_connect_jmp 9888	#
# 0 "" 2
# handlers.c:2489:     def_detour_asm_vars(sys_sendto);
# 2489 "handlers.c" 1
	#define sys_sendto_jmp 9984	#
# 0 "" 2
# handlers.c:2490:     def_detour_asm_vars(sys_sendmsg);
# 2490 "handlers.c" 1
	#define sys_sendmsg_jmp 10080	#
# 0 "" 2
# handlers.c:2491:     def_detour_asm_vars(sys_recvmsg);
# 2491 "handlers.c" 1
	#define sys_recvmsg_jmp 10272	#
# 0 "" 2
# handlers.c:2492:     def_detour_asm_vars(sys_recvfrom);
# 2492 "handlers.c" 1
	#define sys_recvfrom_jmp 10176	#
# 0 "" 2
# handlers.c:2493:     def_detour_asm_vars(sys_close);
# 2493 "handlers.c" 1
	#define sys_close_jmp 10656	#
# 0 "" 2
# handlers.c:2494:     def_detour_asm_vars(sys_dup);
# 2494 "handlers.c" 1
	#define sys_dup_jmp 10368	#
# 0 "" 2
# handlers.c:2495:     def_detour_asm_vars(sys_dup2);
# 2495 "handlers.c" 1
	#define sys_dup2_jmp 10464	#
# 0 "" 2
# handlers.c:2496:     def_detour_asm_vars(sys_dup3);
# 2496 "handlers.c" 1
	#define sys_dup3_jmp 10560	#
# 0 "" 2
# handlers.c:2497:     def_detour_asm_vars(sys_waitid);
# 2497 "handlers.c" 1
	#define sys_waitid_jmp 10752	#
# 0 "" 2
# handlers.c:2498:     def_detour_asm_vars(sys_wait4);
# 2498 "handlers.c" 1
	#define sys_wait4_jmp 10848	#
# 0 "" 2
# handlers.c:2499:     def_detour_asm_vars(sys_sched_rr_get_interval);
# 2499 "handlers.c" 1
	#define sys_sched_rr_get_interval_jmp 10944	#
# 0 "" 2
# handlers.c:2500:     def_detour_asm_vars(sys_execve);
# 2500 "handlers.c" 1
	#define sys_execve_jmp 11040	#
# 0 "" 2
# handlers.c:2501:     def_detour_asm_vars(sys_execveat);
# 2501 "handlers.c" 1
	#define sys_execveat_jmp 11136	#
# 0 "" 2
# handlers.c:2502: }
#NO_APP
	ret
